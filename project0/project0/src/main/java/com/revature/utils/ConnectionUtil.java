...
public class ConnectionUtil {
    ...
    public static Connection getConnection() throws SQLException {
        ...
        String url = "jdbc:postgresql://localhost:5432/postgres?currentSchema=project0real";
        ...
        //Right click LauncherOLD and run it if you don't see these options (creates an application config)
